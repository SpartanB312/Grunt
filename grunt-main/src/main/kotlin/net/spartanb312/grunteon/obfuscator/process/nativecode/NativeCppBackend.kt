...
internal object NativeCppBackend {
    ...
    private fun emitSource(plan: NativeBuildPlan): String {
        return buildString {
            ...
            appendLine("    if (raw == nullptr || grt_string_intern_method == nullptr) return raw;")
            appendLine("    jstring interned = (jstring) env->CallObjectMethod(raw, grt_string_intern_method);")
