...
import net.spartanb312.grunt.ir.ssa.core.SSAResolveDynamicValueInstruction
...
class JvmSSAImporterTest {
    ...
    fun importsSimpleBranchMethod() {
        ...
        val result = JvmSSAImporter().import("example/Test", method)
        val verification = SSAVerifier.verify(result.function)
    ...
    fun importsConstantDynamicAsDynamicValueSite() {
        ...
        val dynamicValues = result.function.blocks
            ...
            .filterIsInstance<SSAResolveDynamicValueInstruction>()
