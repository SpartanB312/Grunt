...
fun NodeFactory.ClassNode(
    src: ClassNode,
    version: Int = src.version,
    access: Int = src.access,
    name: String = src.name,
    signature: String? = src.signature,
    superName: String? = src.superName,
    interfaces: MutableList<String> = src.interfaces.toMutableList(),
    sourceFile: String? = src.sourceFile,
    sourceDebug: String? = src.sourceDebug,
    module: ModuleNode? = src.module,
    outerClass: String? = src.outerClass,
    outerMethod: String? = src.outerMethod,
    outerMethodDesc: String? = src.outerMethodDesc,
    ...
    nestHostClass: String? = src.nestHostClass,
    nestMembers: MutableList<String> = src.nestMembers.toMutableList(),
    permittedSubclasses: MutableList<String> = src.permittedSubclasses.toMutableList(),
    innerClasses: MutableList<InnerClassNode> = src.innerClasses.toMutableList(),
    recordComponents: MutableList<RecordComponentNode> = src.recordComponents.toMutableList(),
    fields: MutableList<FieldNode> = src.fields.toMutableList(),
    methods: MutableList<MethodNode> = src.methods.toMutableList()
) = ClassNode(
    version,
    access,
    name,
